...
def explore_city_data(city_data):
    ...
    StDev = np.std(housing_prices)
    # Printing the results:
    result_clean = np.array([['Number of houses:','Number of features:','Minimum price:','Maximum price:', 'Mean price:', 'Median price:', 'Standard deviation:' ],
...
def performance_metric(label, prediction):
    ...
    ###################################
    perf_metric = mean_squared_error(label, prediction)
    #perf_metric = mean_squared_error(label, prediction)
